...
public class TemplateServiceImpl extends AbstractCurdService<Template, String> implements TemplateService {
    ...
    @Override
    public Template updateTemplate(String templateId, String newTemplate) {
        Template template = templateRepository.findByUuid(templateId);
        template.setHeadContent(newTemplate);
